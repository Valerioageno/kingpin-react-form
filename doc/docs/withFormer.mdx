...
Since it's basically impossible cover all the cases Former allows the creation of custom
...
import { withFormer } from 'react-former'
...
import { Form, Value } from 'react-former'
...
function App(): JSX.Element {
  ...
  return (
    <Form onSubmit={submit}>
      <Select name="hoc-select" initialValue={null} />
